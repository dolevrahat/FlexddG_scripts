...
def rosetta_output_succeeded( potential_struct_dir,mpi=False ):
    #if mpi:
    #    jd_str = 'protocols.jd2.MPIWorkPoolJobDistributor'
    #    success_str = 'Finished job successfully!'
    #else:
    #    jd_str = 'protocols.jd2.JobDistributor'
     #   success_str = 'reported success in'
    global success_str
    ...
    with open( path_to_rosetta_output, 'r' ) as f:
        for line in f:
            ...
            if 'no more batches to process' in line:
...
if __name__ == '__main__':
    ...
    folder_to_analyze = args.output_folder
    mpi = args.mpi
    if mpi:
       success_str = 'Finished job successfully!'
    else:
