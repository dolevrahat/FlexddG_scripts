...
if use_multiprocessing:
    ...
    max_cpus = 10 # We might want to not run on the full number of cores, as Rosetta take about 2 Gb of memory per instance
...
rosetta_scripts_path = os.path.expanduser("/vol/ek/share/rosetta/rosetta_src_2019.14.60699_bundle/main/source/bin/rosetta_scripts.linuxgccrelease")
...
residue_to_mutate = ('E', 8, '') # Residue position to perfrom saturation mutatagenesis. Format: (Chain, PDB residue number, insertion code).
